  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h4 className="text-sm font-bold uppercase tracking-widest text-text-main/60">{title}</h4>
        <span className="text-xs font-mono text-text-main/60">{currentValue}{suffix}</span>
      </div>
