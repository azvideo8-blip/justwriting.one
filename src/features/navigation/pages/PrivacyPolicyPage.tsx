          ...
          <>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li><strong>ИИ-обработка</strong> — текст передаётся в API Gemini (Google) и Fireworks AI для генерации ответов. Текст не сохраняется на наших серверах после обработки.</li>
            ...
            <section>
              ...
              <p>При использовании ИИ-чат, ИИ-редактирования или ИИ-саммаризации текст вашей заметки передаётся во внешний ИИ-API (Google Gemini или Fireworks AI). Мы не сохраняем содержимое запроса на наших серверах после генерации ответа. Метаданные запроса (персона, токены, модель) записываются для лимитирования и аналитики.</p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1 mt-2">
                ...
                <li>Fireworks AI (ИИ-генерация)</li>
          ...
          <>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li><strong>AI processing</strong> — text is sent to Gemini API (Google) and Fireworks AI for response generation. Text is not stored on our servers after processing.</li>
            ...
            <section>
              ...
              <p>When using AI chat, AI editing, or AI summarization, your note text is sent to an external AI API (Google Gemini or Fireworks AI). We do not store request content on our servers after generating a response. Request metadata (persona, tokens, model) is recorded for rate limiting and analytics.</p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1 mt-2">
                <li>Google (Firebase Auth, Firestore, Gemini API)</li>
                <li>Fireworks AI (AI generation)</li>
