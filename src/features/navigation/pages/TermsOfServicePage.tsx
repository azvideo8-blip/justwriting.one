        ...
        {isRu ? (
          <>
            ...
            <section>
              ...
              <p>ИИ-функции (чат, редактирование, саммаризация) предоставляются через сторонние API (OpenRouter). ИИ-ответы носят рекомендательный характер и не являются профессиональной медицинской, психологической или юридической консультацией. Не полагайтесь на ИИ-ответы для принятия критических решений.</p>
            </section>
          ...
          <>
            ...
            <section>
              ...
              <p>AI features (chat, editing, summarization) are provided through third-party APIs (OpenRouter). AI responses are advisory in nature and are not professional medical, psychological, or legal advice. Do not rely on AI responses for critical decisions.</p>
            </section>
