...
export const settingsTranslations: Translations = {
  ...
  storage_sync_pending: { ru: 'Есть неотправленные изменения (кликните для отправки)', en: 'Pending changes (click to sync)' },
  ...
  settings_encryption_not_set_desc: { ru: 'Ваши заметки хранятся в облаке в открытом виде. Настройте шифрование, чтобы защитить их сквозным шифрованием (E2EE).', en: 'Your notes are stored in the cloud in plain text. Configure encryption to protect them with end-to-end encryption (E2EE).' },
  ...
  settings_initialize_confirm: { ru: 'Подтвердите пароль', en: 'Confirm password' },
  ...
  settings_encryption_locked_desc: { ru: 'Введите пароль шифрования, чтобы получить доступ к вашим зашифрованным заметкам.', en: 'Enter your encryption password to access your encrypted notes.' },
