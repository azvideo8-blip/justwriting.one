...
export const authTranslations: Translations = {
  ...
  auth_error_wrong_password_encrypted: { ru: 'Неверный пароль. Если вы сбрасывали пароль через email — ваши зашифрованные данные недоступны с новым паролем. Войдите со старым паролем или обратитесь в поддержку: z8d8@yandex.ru', en: 'Wrong password. If you reset your password via email — your encrypted data is inaccessible with the new password. Sign in with the old password or contact support: z8d8@yandex.ru' },
  ...
  auth_forgot_password_encryption_warning: { ru: '⚠️ Внимание: если у вас есть зашифрованные заметки, после сброса пароля они станут навсегда недоступны. Сброс пароля нельзя отменить.', en: '⚠️ Warning: if you have encrypted notes, they will become permanently inaccessible after password reset. This cannot be undone.' },
