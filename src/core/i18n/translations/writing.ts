...
export const writingTranslations: Translations = {
  ...
  ai_error_rate_limit: { ru: 'Слишком много запросов. Подождите минуту.', en: 'Too many requests. Wait a minute.' },
  ai_error_too_long: { ru: 'Текст слишком длинный', en: 'Text is too long' },
  ai_error_server: { ru: 'Ошибка сервиса. Попробуйте позже.', en: 'Service error. Try again later.' },
};
