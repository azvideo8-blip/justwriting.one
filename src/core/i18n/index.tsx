...
export const translations: Translations = {
  ...
  settings_typewriter: { ru: 'Режим печатной машинки', en: 'Typewriter mode' },
  settings_typewriter_desc: { ru: 'Текущая строка всегда по центру экрана', en: 'Current line stays centered on screen' },
